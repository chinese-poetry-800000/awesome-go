...
* [casbin](https://github.com/hsluoyz/casbin) - Authorization library that supports access control models like ACL, RBAC, ABAC.( ★★★★★ 3414 , Latest commit: Dec 14, 2018 )
...
* [jwt-go](https://github.com/dgrijalva/jwt-go) - Golang implementation of JSON Web Tokens (JWT).( ★★★★★ 4677 , Latest commit: Sep 21, 2018 )
...
* [paseto](https://github.com/o1egl/paseto) - Golang implementation of Platform-Agnostic Security Tokens (PASETO).( ★ 166 , Latest commit: Nov 8, 2018 )
...
* [signedvalue](https://github.com/sashka/signedvalue) - Signed and timestamped strings compatible with [Tornado's](https://github.com/tornadoweb/tornado) `create_signed_value`, `decode_signed_value`, and therefore `set_secure_cookie` and `get_secure_cookie`.( ★★★★★ 17047 , Latest commit: Dec 16, 2018 )
...
* [cobra](https://github.com/spf13/cobra) - Commander for modern Go CLI interactions.( ★★★★★ 9986 , Latest commit: Nov 27, 2018 )
...
* [go-prompt](https://github.com/c-bata/go-prompt) - Library for building a powerful interactive prompt, inspired by [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).( ★★★★★ 4968 , Latest commit: Dec 22, 2018 )
...
* [termtables](https://github.com/apcera/termtables) - Go port of the Ruby library [terminal-tables](https://github.com/tj/terminal-table) for simple ASCII table generation as well as providing markdown and HTML output.( ★★★ 1072 , Latest commit: Jan 23, 2018 )
* [termui](https://github.com/gizak/termui) - Go terminal dashboard based on **termbox-go** and inspired by [blessed-contrib](https://github.com/yaronn/blessed-contrib).( ★★★★★ 12099 , Latest commit: Dec 25, 2018 )
...
* [viper](https://github.com/spf13/viper) - Go configuration with fangs.( ★★★★★ 7094 , Latest commit: Dec 7, 2018 )
...
* [drone](https://github.com/drone/drone) - Drone is a Continuous Integration platform built on Docker, written in Go.( ★★★★★ 16653 , Latest commit: Dec 6, 2018 )
...
* [gods](https://github.com/emirpasic/gods) - Go Data Structures. Containers, Sets, Lists, Stacks, Maps, BidiMaps, Trees, HashSet etc.( ★★★★★ 4933 , Latest commit: Oct 20, 2018 )
...
* [cockroach](https://github.com/cockroachdb/cockroach) - Scalable, Geo-Replicated, Transactional Datastore.( ★★★★★ 15020 , Latest commit: Dec 25, 2018 )
...
* [dgraph](https://github.com/dgraph-io/dgraph) - Scalable, Distributed, Low Latency, High Throughput Graph Database.( ★★★★★ 7183 , Latest commit: Dec 25, 2018 )
...
* [goleveldb](https://github.com/syndtr/goleveldb) - Implementation of the [LevelDB](https://github.com/google/leveldb) key/value database in Go.( ★★★★★ 15830 , Latest commit: Oct 29, 2018 )
...
* [prometheus](https://github.com/prometheus/prometheus) - Monitoring system and time series database.( ★★★★★ 21032 , Latest commit: Dec 25, 2018 )
...
* [tidb](https://github.com/pingcap/tidb) - TiDB is a distributed SQL database. Inspired by the design of Google F1.( ★★★★★ 16558 , Latest commit: Dec 26, 2018 )
* [tiedot](https://github.com/HouzuoGuo/tiedot) - Your NoSQL database powered by Golang.( ★★★★★ 2259 , Latest commit: Jan 5, 2018 )
...
* [sql-migrate](https://github.com/rubenv/sql-migrate) - Database migration tool. Allows embedding migrations into the application using go-bindata.( ★★★ 1186 , Latest commit: Dec 13, 2018 )
...
* [kingshard](https://github.com/flike/kingshard) - kingshard is a high performance proxy for MySQL powered by Golang.( ★★★★★ 3996 , Latest commit: Dec 1, 2018 )
...
* [pgweb](https://github.com/sosedoff/pgweb) - Web-based PostgreSQL database browser.( ★★★★★ 5468 , Latest commit: Dec 24, 2018 )
...
* [vitess](https://github.com/youtube/vitess) - vitess provides servers and tools which facilitate scaling of MySQL databases for large scale web services.( ★★★★★ 7219 , Latest commit: Dec 24, 2018 )
...
* Relational Databases
    ...
    * [go-sql-driver/mysql](https://github.com/go-sql-driver/mysql) - MySQL driver for Go.( ★★★★★ 6678 , Latest commit: Dec 18, 2018 )
...
* NoSQL Databases
    ...
    * [mongo-go-driver](https://github.com/mongodb/mongo-go-driver) - Official MongoDB driver for the Go language.( ★★★★★ 1544 , Latest commit: Dec 19, 2018 )
    ...
    * [redis](https://github.com/go-redis/redis) - Redis client for Golang.( ★★★★★ 4715 , Latest commit: Dec 21, 2018 )
...
* Search and Analytic Databases.
    * [bleve](https://github.com/blevesearch/bleve) - Modern text indexing library for go.( ★★★★★ 4817 , Latest commit: Dec 18, 2018 )
...
* [glow](https://github.com/chrislusf/glow) - Easy-to-Use scalable distributed big data processing, Map-Reduce, DAG execution, all in pure Go.( ★★★★★ 2279 , Latest commit: Nov 1, 2018 )
...
* [go-kit](https://github.com/go-kit/kit) - Microservice toolkit with support for service discovery, load balancing, pluggable transports, request tracking, etc.( ★★★★★ 12231 , Latest commit: Dec 19, 2018 )
* [gorpc](https://github.com/valyala/gorpc) - Simple, fast and scalable RPC library for high load.( ★★★ 503 , Latest commit: May 19, 2016 )
* [grpc-go](https://github.com/grpc/grpc-go) - The Go language implementation of gRPC. HTTP/2 based RPC.( ★★★★★ 7133 , Latest commit: Dec 21, 2018 )
...
* [micro](https://github.com/micro/micro) - Pluggable microservice toolkit and distributed systems platform.( ★★★★★ 5161 , Latest commit: Dec 21, 2018 )
...
* [raft](https://github.com/hashicorp/raft) - Golang implementation of the Raft consensus protocol, by HashiCorp.( ★★★★★ 2322 , Latest commit: Aug 23, 2018 )
* [raft](https://github.com/coreos/etcd/tree/master/raft) - Go implementation of the Raft consensus protocol, by CoreOS.( ★★★★★ 22024 , Latest commit: Dec 7, 2018 )
...
* [sleuth](https://github.com/ursiform/sleuth) - Library for master-less p2p auto-discovery and RPC between HTTP services (using [ZeroMQ](https://github.com/zeromq/libzmq)).( ★★★★★ 4796 , Latest commit: Dec 25, 2018 )
* [tendermint](https://github.com/tendermint/tendermint) - High-performance middleware for transforming a state machine written in any programming language into a Byzantine Fault Tolerant replicated state machine using the Tendermint consensus and blockchain protocols.( ★★★★★ 2586 , Latest commit: Dec 21, 2018 )
...
* [binder](https://github.com/alexeyco/binder) - Go to Lua binding library, based on [gopher-lua](https://github.com/yuin/gopher-lua).( ★★★★★ 2501 , Latest commit: Dec 14, 2018 )
...
* [go-linq](https://github.com/ahmetalpbalkan/go-linq) - .NET LINQ-like query methods for Go.( ★★★★★ 1601 , Latest commit: Oct 24, 2018 )
...
* [jennifer](https://github.com/dave/jennifer) - Generate arbitrary Go code without templates.( ★★★ 1020 , Latest commit: Dec 6, 2018 )
...
* [gopherjs](https://github.com/gopherjs/gopherjs) - Compiler from Go to JavaScript.( ★★★★★ 7723 , Latest commit: Nov 3, 2018 )
...
* [ants](https://github.com/panjf2000/ants) - A high-performance goroutine pool for golang.( ★★★ 1101 , Latest commit: Dec 7, 2018 )
...
* [fyne](https://github.com/fyne-io/fyne) - Cross platform native GUIs designed for Go, rendered using EFL. Supports: Linux, macOS, Windows.( ★ 284 , Latest commit: Dec 24, 2018 )
...
* [qt](https://github.com/therecipe/qt) - Qt binding for Go (support for Windows / macOS / Linux / Android / iOS / Sailfish OS / Raspberry Pi).( ★★★★★ 4976 , Latest commit: Dec 23, 2018 )
...
* [resize](https://github.com/nfnt/resize) - Image resizing for Go with common interpolation methods.( ★★★★★ 1957 , Latest commit: Feb 21, 2018 )
...
* [flogo](https://github.com/tibcosoftware/flogo) - Project Flogo is an Open Source Framework for IoT Edge Apps & Integration.( ★★★ 865 , Latest commit: Dec 14, 2018 )
...
* [logrus](https://github.com/Sirupsen/logrus) - Structured logger for Go.( ★★★★★ 9339 , Latest commit: Dec 15, 2018 )
* [logrusly](https://github.com/sebest/logrusly) - [logrus](https://github.com/sirupsen/logrus) plug-in to send errors to a [Loggly](https://www.loggly.com/).( ★★★★★ 9339 , Latest commit: Dec 15, 2018 )
...
* [GoLearn](https://github.com/sjwhitworth/golearn) - General Machine Learning library for Go.( ★★★★★ 6165 , Latest commit: Aug 31, 2018 )
...
* [gorgonia](https://github.com/chewxy/gorgonia) - graph-based computational library like Theano for Go that provides primitives for building various machine learning and neural network algorithms.( ★★★★★ 2314 , Latest commit: Nov 9, 2018 )
...
* [go-nsq](https://github.com/nsqio/go-nsq) - the official Go package for NSQ.( ★★★★★ 1264 , Latest commit: Oct 29, 2018 )
...
* [gorush](https://github.com/appleboy/gorush) - Push notification server using [APNs2](https://github.com/sideshow/apns2) and google [GCM](https://github.com/google/go-gcm).( ★ 102 , Latest commit: Feb 14, 2017 )
...
* [machinery](https://github.com/RichardKnop/machinery) - Asynchronous task queue/job queue based on distributed message passing.( ★★★★★ 2790 , Latest commit: Dec 24, 2018 )
...
* [Mercure](https://github.com/dunglas/mercure) - Server and library to dispatch server-sent updates using the Mercure protocol (built on top of Server-Sent Events).( ★★★ 777 , Latest commit: Dec 17, 2018 )
...
* [sarama](https://github.com/Shopify/sarama) - Go library for Apache Kafka.( ★★★★★ 3731 , Latest commit: Dec 14, 2018 )
...
* [ffmt](https://github.com/go-ffmt/ffmt) - Beautify data display for Humans.( ★ 92 , Latest commit: Dec 3, 2018 )
...
* [persian](https://github.com/mavihq/persian) - Some utilities for Persian language in go.( ★ 24 , Latest commit: Jul 20, 2018 )
...
* [gojieba](https://github.com/yanyiwu/gojieba) - This is a Go implementation of [jieba](https://github.com/fxsjy/jieba) which a Chinese word splitting algorithm.( ★★★★★ 16590 , Latest commit: Dec 3, 2018 )
...
* [prose](https://github.com/jdkato/prose) - Library for text processing that supports tokenization, part-of-speech tagging, named-entity extraction, and more.( ★★★★★ 1849 , Latest commit: Oct 22, 2018 )
...
* [fasthttp](https://github.com/valyala/fasthttp) - Package fasthttp is a fast HTTP implementation for Go, up to 10 times faster than net/http.( ★★★★★ 7680 , Latest commit: Dec 13, 2018 )
...
* [kcptun](https://github.com/xtaci/kcptun) - Extremely simple & fast udp tunnel based on KCP protocol.( ★★★★★ 9251 , Latest commit: Oct 27, 2018 )
...
* [quic-go](https://github.com/lucas-clemente/quic-go) - An implementation of the QUIC protocol in pure Go.( ★★★★★ 2206 , Latest commit: Dec 21, 2018 )
...
* [beego orm](https://github.com/astaxie/beego/tree/master/orm) - Powerful orm framework for go. Support: pq/mysql/sqlite3.( ★★★★★ 18344 , Latest commit: Nov 20, 2018 )
...
* [Xorm](https://github.com/go-xorm/xorm) - Simple and powerful ORM for Go.( ★★★★★ 4182 , Latest commit: Dec 20, 2018 )
...
* [glide](https://github.com/Masterminds/glide) - Manage your golang vendor and vendored packages with ease. Inspired by tools like Maven, Bundler, and Pip.( ★★★★★ 7362 , Latest commit: Sep 26, 2018 )
...
* [govendor](https://github.com/kardianos/govendor) - Go Package Manager. Go vendor tool that works with the standard vendor file.( ★★★★★ 4156 , Latest commit: Nov 14, 2018 )
...
* [graphql-go](https://github.com/graphql-go/graphql) - Implementation of GraphQL for Go.( ★★★★★ 4066 , Latest commit: Dec 10, 2018 )
...
* [packr](https://github.com/gobuffalo/packr) - The simple and easy way to embed static files into Go binaries.( ★★★★★ 1475 , Latest commit: Dec 12, 2018 )
...
* [gonum](https://github.com/gonum/gonum) - Gonum is a set of numeric libraries for the Go programming language. It contains libraries for matrices, statistics, optimization, and more.( ★★★★★ 2269 , Latest commit: Dec 22, 2018 )
...
* [go-yara](https://github.com/hillu/go-yara) - Go Bindings for [YARA](https://github.com/plusvic/yara), the "pattern matching swiss knife for malware researchers (and everyone else)".( ★ 74 , Latest commit: Jun 8, 2016 )
...
* [secure](https://github.com/unrolled/secure) - HTTP middleware for Go that facilitates some quick security wins.( ★★★ 1062 , Latest commit: Dec 21, 2018 )
...
* [goprotobuf](https://github.com/golang/protobuf) - Go support, in the form of a library and protocol compiler plugin, for Google's protocol buffers.( ★★★★★ 3865 , Latest commit: Nov 28, 2018 )
...
* [mapstructure](https://github.com/mitchellh/mapstructure) - Go library for decoding generic map values into native Go structures.( ★★★★★ 1896 , Latest commit: Oct 4, 2018 )
...
* [Caddy](https://github.com/mholt/caddy) - Caddy is an alternative, HTTP/2 web server that's easy to configure and use.( ★★★★★ 19752 , Latest commit: Dec 19, 2018 )
...
* [etcd](https://github.com/coreos/etcd) - Highly-available key value store for shared configuration and service discovery.( ★★★★★ 22024 , Latest commit: Dec 23, 2018 )
...
* [minio](https://github.com/minio/minio) - Minio is a distributed object storage server.( ★★★★★ 14038 , Latest commit: Dec 23, 2018 )
* [nsq](http://nsq.io/) - A realtime distributed messaging platform.
* [RoadRunner](https://github.com/spiral/roadrunner) - High-performance PHP application server, load-balancer and process manager.( ★★★★★ 2159 , Latest commit: Dec 20, 2018 )
...
* Testing Frameworks
    ...
    * [endly](https://github.com/viant/endly) - Declarative end to end functional testing.( ★ 59 , Latest commit: Dec 24, 2018 )
    ...
    * [GoConvey](https://github.com/smartystreets/goconvey/) - BDD-style framework with web UI and live reload.( ★★★★★ 4119 , Latest commit: Nov 7, 2018 )
    ...
    * [gofight](https://github.com/appleboy/gofight) - API Handler Testing for Golang Router framework.( ★ 213 , Latest commit: Dec 26, 2018 )
...
* Selenium and browser control tools.
    * [cdp](https://github.com/mafredri/cdp) - Type-safe bindings for the Chrome Debugging Protocol that can be used with browsers or other debug targets that implement it.( ★ 218 , Latest commit: Dec 15, 2018 )
...
* Specific Formats
    ...
    * [inject](https://github.com/facebookgo/inject) - Package inject provides a reflect based injector.( ★★★ 1040 , Latest commit: Jul 5, 2018 )
...
* [aws-sdk-go](https://github.com/aws/aws-sdk-go) - The official AWS SDK for the Go programming language.( ★★★★★ 4400 , Latest commit: Dec 21, 2018 )
...
* [github](https://github.com/google/go-github) - Go library for accessing the GitHub REST API v3.( ★★★★★ 4172 , Latest commit: Dec 22, 2018 )
...
* [delve](https://github.com/derekparker/delve) - Go debugger.( ★★★★★ 10096 , Latest commit: Dec 3, 2018 )
...
* [fzf](https://github.com/junegunn/fzf) - Command-line fuzzy finder written in Go.( ★★★★★ 18585 , Latest commit: Dec 22, 2018 )
...
* [goreporter](https://github.com/wgliang/goreporter) - Golang tool that does static analysis, unit testing, code review and generate code quality report.( ★★★★★ 2277 , Latest commit: Sep 2, 2018 )
...
* [immortal](https://github.com/immortal/immortal) - \*nix cross-platform (OS agnostic) supervisor.( ★★★ 557 , Latest commit: Dec 17, 2018 )
...
* [minify](https://github.com/tdewolff/minify) - Fast minifiers for HTML, CSS, JS, XML, JSON and SVG file formats.( ★★★★★ 1630 , Latest commit: Dec 10, 2018 )
...
* [realize](https://github.com/tockins/realize) - Go build system with file watchers and live reload. Run, build and watch file changes with custom paths.( ★★★★★ 2682 , Latest commit: Sep 18, 2018 )
...
* [sqlx](https://github.com/jmoiron/sqlx) - provides a set of extensions on top of the excellent built-in database/sql package.( ★★★★★ 5452 , Latest commit: Oct 24, 2018 )
...
* [govalidator](https://github.com/thedevsaddam/govalidator) - Validate Golang request data with simple rules. Highly inspired by Laravel's request validation.( ★★★ 526 , Latest commit: Nov 22, 2018 )
* [ozzo-validation](https://github.com/go-ozzo/ozzo-validation) - Supports validation of various data types (structs, strings, maps, slices, etc.) with configurable and extensible validation rules specified in usual code constructs instead of struct tags.( ★★★ 836 , Latest commit: Nov 16, 2018 )
...
* [validator](https://github.com/go-playground/validator) - Go Struct and Field validation, including Cross Field, Cross Struct, Map, Slice and Array diving.( ★★★★★ 2507 , Latest commit: Dec 8, 2018 )
...
* [Beego](https://github.com/astaxie/beego) - beego is an open-source, high-performance web framework for the Go programming language.( ★★★★★ 18344 , Latest commit: Dec 19, 2018 )
* [Buffalo](http://gobuffalo.io) - Bringing the productivity of Rails to Go!
* [Echo](https://github.com/labstack/echo) - High performance, minimalist Go web framework.( ★★★★★ 12491 , Latest commit: Dec 5, 2018 )
...
* [Gin](https://github.com/gin-gonic/gin) - Gin is a web framework written in Go! It features a martini-like API with much better performance, up to 40 times faster. If you need performance and good productivity.( ★★★★★ 23148 , Latest commit: Dec 25, 2018 )
...
* [Microservice](https://github.com/claygod/microservice) - The framework for the creation of microservices, written in Golang.( ★ 48 , Latest commit:  )
...
* [rex](https://github.com/goanywhere/rex) - Rex is a library for modular development built upon gorilla/mux, fully compatible with `net/http`.( ★ 24 , Latest commit:  )
...
* [utron](https://github.com/gernest/utron) - Lightweight MVC framework for Go(Golang).( ★★★★★ 2103 , Latest commit: Oct 28, 2018 )
...
* [chi](https://github.com/go-chi/chi) - Small, fast and expressive HTTP router built on net/context.( ★★★★★ 4719 , Latest commit: Dec 21, 2018 )
...
* [httprouter](https://github.com/julienschmidt/httprouter) - High performance router. Use this and the standard http handlers to form a very high performance web framework.( ★★★★★ 8329 , Latest commit: Oct 22, 2018 )
...
* [mux](https://github.com/gorilla/mux) - Powerful URL router and dispatcher for golang.( ★★★★★ 7795 , Latest commit: Dec 25, 2018 )
...
* [go-callvis](https://github.com/TrueFurby/go-callvis) - Visualize call graph of your Go program using dot format.( ★★★★★ 1407 , Latest commit: Sep 22, 2018 )
...
* [OctoLinker](https://github.com/OctoLinker/browser-extension) - Navigate through go files efficiently with the OctoLinker browser extension for GitHub.( ★★★★★ 3108 , Latest commit: Dec 18, 2018 )
...
* [Gitea](https://github.com/go-gitea/gitea) - Fork of Gogs, entirely community driven.( ★★★★★ 11384 , Latest commit: Dec 24, 2018 )
...
* [GVM](https://github.com/moovweb/gvm) - GVM provides an interface to manage Go versions.( ★★★★★ 4012 , Latest commit: Jul 18, 2018 )
...
* [kubernetes](https://github.com/kubernetes/kubernetes) - Container Cluster Manager from Google.( ★★★★★ 45829 , Latest commit: Dec 26, 2018 )
...
* [Moby](https://github.com/moby/moby) - Collaborative project for the container ecosystem to assemble container-based systems.( ★★★★★ 51635 , Latest commit: Dec 25, 2018 )
...
* [Comcast](https://github.com/tylertreat/Comcast) - Simulate bad network connections.( ★★★★★ 5874 , Latest commit: Oct 20, 2018 )
...
* [nes](https://github.com/fogleman/nes) - Nintendo Entertainment System (NES) emulator written in Go.( ★★★★★ 3877 , Latest commit: Feb 22, 2018 )
...
* [Pipe](https://github.com/b3log/pipe) - A small and beautiful blogging platform.( ★★★★★ 1762 , Latest commit: Dec 26, 2018 )
...
* [Seaweed File System](https://github.com/chrislusf/seaweedfs) - Fast, Simple and Scalable Distributed File System with O(1) disk seek.( ★★★★★ 7050 , Latest commit: Dec 25, 2018 )
...
* [Go Projects](https://github.com/golang/go/wiki/Projects) - List of projects on the Go community wiki.( ★★★★★ 51114 , Latest commit: Dec 25, 2018 )
...
* [Build web application with Golang](https://github.com/astaxie/build-web-application-with-golang) - Golang ebook intro how to build a web app with golang.( ★★★★★ 26993 , Latest commit: Dec 16, 2018 )
